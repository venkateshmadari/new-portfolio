...
export default function About() {
  return (
    <section
      className={` flex items-center justify-center w-full bg-black flex-col`}
    >
      ...
      <p
        className={`md:max-w-4xl px-8 text-center text-white text-base md:text-3xl leading-relaxed py-6  ${forum.className}`}
      >
        I am a{" "}
        <strong
          className={`text-shade  font-semibold ${forum.className}`}
